    ...
    return (
        <div className="h-full w-full flex flex-col text-white">
            ...
            <div className="mb-12 flex-shrink-0">
                <button
                    onClick={onBack}
                    className="text-primary hover:text-primary/80 mb-4 text-sm font-medium transition-colors"
                >
                    ← Back to Projects
                </button>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-heading dark:text-heading text-center">
                    {project.title}
                </h1>
            </div>

            {/* Main Content */}
            <div className="flex row gap-12 min-h-0">
                {/* Left Side - Project Image */}
                <div className="flex w-1/2 flex-col gap-4">
                    <div className="relative w-full h-2/3 sm:h-2/3 border border-primary bg-black rounded-lg overflow-hidden flex-shrink-0"
                        style={{
                    ...
                    {/* Tech Stack Section */}
                    <div
                        className="rounded-lg p-4 border border-primary"
                        style={{
                            background: "linear-gradient(90deg, rgba(81, 112, 255, 0.6), rgba(0, 4, 61, 0.6))",
                        }}
                    >
                        <h3 className="text-base sm:text-lg font-semibold text-heading dark:text-heading mb-3">
                            Tech Stack
                        </h3>
                        <div className="flex flex-wrap gap-3">
                            {project.technologies.map((tech) => {
                                ...
                                return (
                                    <div
                                        key={tech}
                                        className="w-10 h-10 rounded-lg bg-black border border-gray-800 flex items-center justify-center hover:border-primary/50 transition-all"
                                        title={tech}
                                    >
                                        {IconComponent ? (
                ...
                <div className="flex w-1/2 flex-col">
                    ...
                    >
                        <p className="text-base sm:text-lg leading-relaxed text-text dark:text-text whitespace-pre-line">
